        ...
        <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-[#e2b619] selection:text-black">
            ...
            {view === 'landing' && (
                <div className="flex flex-col items-center justify-center min-h-screen p-8 text-center bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-neutral-900 to-[#050505]">
                    ...
                    <h1 className="text-6xl font-black italic tracking-tighter mb-4">KÈNE AI <span className="text-[#e2b619]">AUDIT</span></h1>
            ...
            {view === 'report' && auditResult && (
                <div className="max-w-4xl mx-auto p-6 pt-12 pb-32 animate-in fade-in zoom-in-95 duration-700">
                    ...
                    {/* Header */}
                    <header className="text-center mb-16 border-b border-neutral-800 pb-8">
                        <div className="text-[#e2b619] text-sm font-black uppercase tracking-[0.3em] mb-2">KÈNE AI AUDIT</div>
                        <h1 className="text-5xl font-black italic tracking-tighter">{intel.businessName.toUpperCase()}</h1>
                        <div className="text-neutral-500 text-xs font-bold uppercase tracking-widest mt-2">Version 5.0</div>
                    </header>
                    ...
                    <section className="mb-20">
                        ...
                        <div className="text-center my-8">
                            <h3 className="text-lg font-bold text-neutral-400">Implementing this roadmap unlocks:</h3>
                        </div>
